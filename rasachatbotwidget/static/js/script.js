...
function action_trigger() {
    ...
    $.ajax({
        url: `http://localhost:2002/conversations/${user_id}/execute`,
        type: "POST",
...
function send(message) {
    ...
    $.ajax({
        url: "http://localhost:2002/webhooks/rest/webhook",
        type: "POST",
        contentType: "application/json",
...
function setBotResponse(response) {
    ...
    setTimeout(function() {
        ...
        if (response.length < 1) {
            ...
            var fallbackMsg = "Tôi đang gặp một số vấn đề, vui lòng thử lại sau!!!";
